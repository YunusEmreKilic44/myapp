...
class LoginPageState extends State<LoginPage> {
  final TextEditingController kullaniciAdiKontrolcusu =
      TextEditingController(); // Kullanıcı adı için controller.
  final TextEditingController parolaKontrolcusu =
      TextEditingController(); // Şifre için controller.
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text(
                "Kullanıcı Adı: ${kullaniciAdiKontrolcusu.text}",
